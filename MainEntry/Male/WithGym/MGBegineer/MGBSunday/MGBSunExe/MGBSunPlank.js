  ...
  return (
    <ScrollView style={{backgroundColor:themeColors.bg, flex:1}} >
      ...
      <SafeAreaView style={{flexDirection: 'row', justifyContent: 'center',marginTop:15}}>
          <Image
            source={require('../../MGBAssets/plankM.gif')}
      ...
      <View style={{marginTop:20}}>
        ...
        <Text style={styles.discrip}> Hold a plank position on your elbows and toes, engaging your core.</Text>
      </View>

      <View style={{marginTop:20}}>
        <Text style={styles.header}>Uses</Text>
        <Text style={styles.discrip}>  Plank reduces the stress on our spine and gives us a straight, well aligned body while walking, standing and sitting.</Text>
      </View>
