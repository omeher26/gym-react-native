  ...
  return (
    <ScrollView style={{backgroundColor:themeColors.bg, flex:1}} >
      ...
      <View style={{marginTop:20}}>
        <Text style={styles.title}>Dumbbell Bench Press (3 sets of 10 reps) </Text>
      </View>

      <SafeAreaView style={{flexDirection: 'row', justifyContent: 'center',marginTop:15}}>
          <Image
            source={require('../../MGBAssets/DumbBenPressM.gif')}
      ...
      <View style={{marginTop:20}}>
        ...
        <Text style={styles.discrip}>1 - Lie on a bench and hold a dumbbell in each hand at chest level</Text>
        <Text style={styles.discrip}>2 - Press the dumbbells up towards the ceiling, then lower them back 
down.</Text>
      </View>

      <View style={{marginTop:20}}>
        <Text style={styles.header}>Uses</Text>
        <Text style={styles.discrip}>  Dumbbell bench presses build muscle in your upper body.</Text>
      </View>
