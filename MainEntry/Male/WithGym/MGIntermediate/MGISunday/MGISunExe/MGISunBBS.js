  ...
  return (
    <ScrollView style={{backgroundColor:themeColors.bg, flex:1}} >
      ...
      <View style={{marginTop:20}}>
        <Text style={styles.title}>Barbell Back Squats (4 sets of 8 reps)</Text>
      </View>

      <SafeAreaView style={{flexDirection: 'row', justifyContent: 'center',marginTop:15}}>
          <Image
            source={require('../../MGIAssets/barbellBackSqutIM.gif')}
      ...
      <View style={{marginTop:20}}>
        ...
        <Text style={styles.discrip}> 2 -  Perform squats, focusing on maintaining proper form and increasing weight gradually.</Text>
      </View>

      <View style={{marginTop:20}}>
        <Text style={styles.header}>Uses</Text>
        <Text style={styles.discrip}>   Barbell back squat is an effective exercise for strengthening the leg and back muscles. It can also improve core strength.</Text>
      </View>
