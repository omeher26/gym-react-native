  ...
  return (
    <SafeAreaView style={{backgroundColor:themeColors.bg, flex:1}} >
      ...
      <View style={{marginTop:100}}>
          <TouchableOpacity style={styles.loginBtn} onPress={() => navigation.navigate('Female gym begg days')} >
            <Text style={{color:'#464545',fontSize:15, textAlign:'center',fontWeight:'bold'}}>Beginner</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.loginBtn} onPress={() => navigation.navigate('Female gym interme days')} >
            <Text style={{color:'#464545',fontSize:15, textAlign:'center',fontWeight:'bold'}}>Intermediate</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.loginBtn} onPress={() => navigation.navigate('Female gym advance days')}>
