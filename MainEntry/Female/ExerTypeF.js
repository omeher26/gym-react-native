  ...
  return (
    <SafeAreaView style={{backgroundColor:themeColors.bg, flex:1}} >
      ...
      <View style={{marginTop:100}}>
          <TouchableOpacity style={styles.loginBtn} onPress={() => navigation.navigate('Female with gym')} >
            <Text style={{color:'#464545',fontSize:15, textAlign:'center',fontWeight:'bold'}}>With Gym</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.loginBtn} onPress={() => navigation.navigate('Female with dumbles')} >
            <Text style={{color:'#464545',fontSize:15, textAlign:'center',fontWeight:'bold'}}>With Dumbbells</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.loginBtn} onPress={() => navigation.navigate('Female without equipments')} >
